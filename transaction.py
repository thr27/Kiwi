...
class Atomic(ContextDecorator):
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        print "***** EXIT", exc_type, exc_value, traceback, sid, connection.in_atomic_block, connection.needs_rollback
        ...
        try:
            if connection.closed_in_transaction:
                ...
                print "***** NEEDS ROLLBACK", exc_type, exc_value, traceback, sid, connection.in_atomic_block, connection.needs_rollback
                ...
                print "***** DOESN'T NEED ROLLBACK", exc_type, exc_value, traceback, sid, connection.in_atomic_block, connection.needs_rollback
